...
<template>
	...
	<div
        ...
        rounded-2xl p-6 flex flex-col justify-center items-center transition duration-150 ease-in-out mt-auto border-zinc-300 dark:border-zinc-600"
		:class="{'border-green-200 bg-green-100 scale-105 dark:border-green-400 dark:bg-green-900/30': props.vm.isDragHovering}">
		<svg
			xmlns="http://www.w3.org/2000/svg" height="24"
			viewBox="0 -960 960 960" width="24" class="w-8 h-8 fill-current">
